...
class BusinessServicesResource:
    ...
    def get(self, service_id: str) -> BusinessServiceConfig:
        ...
        return self._http.get(f'{self._base_path}/{service_id}', response_model=BusinessServiceConfig)
    ...
    def generate_qr_code(self, service_id: Optional[str] = None) -> ServiceQRCode:
        ...
        return self._http.get(
            f'{self._base_path}/qr-code/generate{query_string}',
            response_model=ServiceQRCode
        )
