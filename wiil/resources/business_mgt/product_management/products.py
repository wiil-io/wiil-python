...
class ProductsResource:
    ...
    def set_category_display_order(
        ...
        """Set the display order for a product category."""
        return self._http.patch(
    ...
    def create(self, data: CreateBusinessProduct) -> ProductDisplay:
    ...
    def update_status(
        ...
        """Update the status (active/inactive) of a product."""
        return self._http.patch(
            f'{self._base_path}/products/{product_id}/status',
            {'isActive': is_active},
            response_model=BusinessProduct
        )
